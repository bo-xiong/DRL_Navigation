...
from constants import ACTION_SIZE # 动作空间大小4
from constants import PARALLEL_SIZE # 并行线程个数
from constants import INITIAL_ALPHA_LOW
from constants import INITIAL_ALPHA_HIGH
from constants import INITIAL_ALPHA_LOG_RATE
from constants import MAX_TIME_STEP # 最大训练次数 10 million frames
from constants import CHECKPOINT_DIR # 保存点目录 'checkpoints'
from constants import LOG_FILE #日志文件 'logs'
from constants import RMSP_EPSILON # epsilon parameter for RMSProp 0.1
from constants import RMSP_ALPHA # decay parameter for RMSProp 0.99
from constants import GRAD_NORM_CLIP # gradient norm clipping  40.0
from constants import USE_GPU # False
from constants import TASK_TYPE # 'navigation'
